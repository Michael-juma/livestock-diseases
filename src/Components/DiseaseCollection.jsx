        ...
        <table className="table table-bordered border-danger table-striped table-hover">
          <thead>
            ...
            <tr>
              ...
              <td className="p-4">
                High fever (lasts 2–3 days) Excessive salivation ("drooling")
                Blisters (vesicles) on: Mouth and tongue (causes drooling,
                difficulty eating) Hooves (leads to limping or lameness) Teats
                (can reduce milk production) Depression, weight loss Decrease in
                milk yield Painful movement or reluctance to move
              </td>
